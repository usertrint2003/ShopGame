...
<head>
    ...
    <title>Danh sách toàn khoản</title>
...
<body>
            ...
            <div class="flex">
                ...
                <div class="flex items-center justify-end ml-14">
                    <ul class="flex justify-between mx-auto font-bold">
                        <li class="md:mx-6"><a href="../Trang-chu" class="">Trang Chủ</a></li>
                        <li class="md:mx-6 mx-2"><a href="../Gioi-thieu">Giới thiệu</a></li>
                        <?php if (isset($_SESSION["auth"])) : ?>
                            <li class="md:mx-6"><a href="../Nap-the">Nạp thẻ</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
    ...
    <div class="container mx-auto mt-10">
        <div class="flex justify-center">
            <div class="text-[48px] text-red-500">
                Tài khoản game <?= $categories->name ?>
            </div>
        </div>
        <div class="grid md:grid-cols-4  grid-cols-2 gap-4 mt-5">
            <?php foreach ($products as $product) : ?>
                <?php if ($product->status == 1) : ?>
                    <div>
                        <a href="../Tai-khoan/Chi-tiet-tai-khoan?id=<?= $product->id ?>">
                            <div class="border-2 border-[#EFA969] rounded-xl p-4" id="anh">
                                <div class="">
                                    <img src="/images/products/<?= $product->image ?>" alt="" class="">
                                </div>
                                <div class="flex justify-center mt-5">
                                    <p class="font-semibold text-[24px]"><?= $product->name ?></p>
                                </div>
                                <div class="flex justify-center">
                                    <span class="text-red-500 font-bold ">Giá: <?= $this->currency_format($product->price) ?></span>
                                </div>
