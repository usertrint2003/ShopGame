            ...
            <div class="flex">
                ...
                <div class="flex items-center justify-end ml-14">
                    <ul class="flex justify-between mx-auto font-bold">
                        ...
                        <li class="mx-6"><a href="">Giới thiệu</a></li>
                    ...
                    <div>
                        <div class="flex justify-center">
                            <div class="text-center">
                                ...
                                <span class="text-[32px] font-bold">Xác minh</span>
                            </div>
                        </div>

                        <div class="mt-[48px]">
                            <div class="my-3 font-bold">Nhập Code</div>
                            <input type="text" name="code" class="border border-[#32C5D2] w-[400px] py-4 pl-4 rounded-[5px]" placeholder="John.snow@gmail.com">
                        </div>
                        ...
                        <div>
                            ...
                            <button class="underline text-[#2a88e6] hover:underline hover:text-[#ff4400]" name="resend">Gửi lại mã</button>
                        </div>

                        <div class="w-[400px] mt-[30px] font-bold text-white p-4 flex bg-[#32C5D2] justify-center items-center">
                            <button name="btn_code">Gửi</button>
                        </div>
