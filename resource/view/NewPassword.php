                ...
                <div>
                    <div class="flex justify-center">
                        <div class="text-center">
                            ...
                            <span class="text-[32px] font-bold">Mật khẩu mới</span>
                        </div>
                    </div>

                    <div class="">
                        <div class="my-3 font-bold">Mật khẩu mới</div>
                    ...
                    <div class="">
                        <div class="my-3 font-bold">Xác nhận mật khẩu mới</div>
                    ...
                    <div class="w-[400px] mt-[30px] font-bold text-white p-4 flex bg-[#32C5D2] justify-center items-center">
                        <button onclick="return checkFormRegister()" name="btn_code">Tạo</button>
                    </div>
