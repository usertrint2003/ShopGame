                ...
                <form action="" class="w-[600px] flex justify-center mb-[190px]" method="POST">
                    <div>
                        ...
                        <div class="">
                            ...
                            <!-- <button id="hidden-password"><i class="fa fa-eye-slash"></i></button> -->
                        ...
                        <div class="w-[400px] mt-[30px] font-bold text-white p-4 flex bg-[#32C5D2] justify-center items-center cursor-pointer">
