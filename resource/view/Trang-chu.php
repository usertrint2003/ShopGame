    ...
    <div class="">
        ...
        <div class="container mx-auto mt-10">
            ...
            <?php foreach ($categories as $cate) : ?>
                <div class="mt-5">
                    <div class="flex justify-center text-[32px] text-red-500">
                        Danh Mục Game <?= $cate->name ?>
                    </div>

                    <div class="grid md:grid-cols-4  grid-cols-2 gap-4 mt-5">
                        <div>
                            <a href="./Tai-khoan/Tai-khoan-game?id=<?= $cate->id ?>">
                                <div class="border-2 border-[#EFA969] rounded-xl p-4" id="anh">
                                    <div class="flex justify-center">
                                        <img src="images/categories/<?= $cate->image ?>" alt="" class="">
                                    </div>
                                    <div class="flex justify-center mt-5">
                                        <p class="font-semibold text-[24px] text-[#32C5D2]">Tài Khoản Nick <?= $cate->name ?></p>
                                    </div>

                                    <!-- <div class="flex justify-center mt-5">
                                        <p class="font-semibold text-[24px] text-[#32C5D2]">Còn lại <?= $products->productCount ?></p>
                                    </div> -->
                                    <!-- <div class="flex justify-center">
                                    <span class="text-red-500 font-bold ">Số tài khoản: 31232131</span>
                                </div> -->
                                    <div class="flex justify-center mt-3 mb-4">
                                        <button class="border border-[#EFA969] rounded-xl font-bold w-[100px] text-[18px] hover:bg-[#EFA969]  hover:text-white p-1 w-[120px]">Xem tất cả</button>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            <!-- <div class="mt-5">
                <div class="flex justify-center text-[32px]">
                ...
                <div class="grid grid-cols-4 gap-4 mt-5">
                    ...
                    <div>
                        <a href="./Tai-khoan/Lien-minh">
                            <div class="border-2 border-[#EFA969] rounded-xl p-4" id="anh">
                                <div class="">
                                    <img src="images/categories/ShopFreeFire.gif" alt="" class="">
                                </div>
                                <div class="flex justify-center mt-5">
                                    <p class="font-semibold text-[24px]">Tài khoản nick Liên minh</p>
                                </div>
                                <div class="flex justify-center">
                                    <span class="text-red-500 font-bold ">Số tài khoản: 31232131</span>
                                </div>
            ...
            <div class="mt-5">
                ...
                <div class="grid grid-cols-4 gap-4 mt-5">
                    ...
                    <div>
                        <div class="border-2 border-[#EFA969] rounded-xl p-4" id="anh">
                            <div class="">
                                <img src="images/categories/ShopLienMinh.gif" alt="" class="">
                            </div>
                            <div class="flex justify-center mt-5">
                                <p class="font-semibold text-[24px]">Tài khoản nick liên quân</p>
                            </div>
                            <div class="flex justify-center">
                                <span class="text-red-500 font-bold ">Số tài khoản: 31232131</span>
                            </div>
            ...
            <div class="mt-5">
                ...
                <div class="grid grid-cols-4 gap-4 mt-5">
                    <div>
                        <div class="border-2 border-[#EFA969] rounded-xl p-4" id="anh">
                            <div class="">
                                <img src="images/categories/ShopTocChien.gif" alt="" class="">
                            </div>
                            <div class="flex justify-center mt-5">
                                <p class="font-semibold text-[24px]">Tài khoản nick liên quân</p>
                            </div>
