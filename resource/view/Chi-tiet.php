                    ...
                    <form action="" method="post">
                        <div class="body__header">
                            <div class="body__header-title flx font_title">
                                <div class="body__header-title-row">
                                    <div class="body__account_id p-1 bold">Sản phẩm: <?= $products->id ?></div>
                                ...
                                <div class="body__header-title-row">
                                    <div class="body_account_card p-1">Giá tiền: <?= $this->currency_format($products->price) ?></div>
                                    <!-- <div class="body_account_atm p-1">900,000 ATM</div> -->
                                </div>

                                <div class="body__header-title-row">
                                    <?php if ($this->is_auth()) : ?>
                                        <?php if ($_SESSION["auth"]->money > $products->price) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else : ?>
                                        <h1>Bạn phải đăng nhập mới mua được</h1>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="body__header-information font_title flx">
                                <div class="body__header-information-row">
                                    <div class="body__account_tuong p-1 bold">Mô tả: <span class="color-red"><?= $products->description ?></span></div>
                        ...
                        <div class="container">
                            <div class="body__content-img flx">
                                <img src="/images/products/<?= $products->image ?>" alt="" srcset="">
                            </div>
                        </div>
