    ...
    <div class="flex items-center justify-center">
        <form action="" class="w-[600px] rounded-[10px] border border-[#000] p-4 shadow shadow-[#000]" method="POST" enctype="multipart/form-data">
            ...
            <div class="pt-5 ">
                ...
                <textarea name="description" id="" class="border pl-2 border-[#000] h-[100px] w-[90%]"></textarea>
            </div>

            <div class="pt-5">
                <div class="font-bold mb-3 text-[18px]">Tài khoản</div>
                <input type="text" name="account_product" class="border pl-2 border-[#000] h-[40px] w-[75%] rounded-[10px]">
            </div>

            <div class="pt-5">
                <div class="font-bold mb-3 text-[18px]">Mật khẩu</div>
                <input type="text" name="password_product" class="border pl-2 border-[#000] h-[40px] w-[75%] rounded-[10px]">
            </div>
            ...
            <div class="pt-5 flex justify-center">
                <button type="submit" class="bg-[#000] text-white w-[200px] text-[20px] h-[40px] hover:bg-red-500">Thêm mới</button>
            </div>
        </form>
    </div>
</body>
