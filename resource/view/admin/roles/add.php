...
<head>
    ...
    <title>Form Thêm Mới Chức Vụ</title>
    ...
    <div class="flex items-center justify-center">
        <form action="" class="w-[600px] rounded-[10px] border border-[#000] p-4 shadow shadow-[#000]" method="POST" enctype="multipart/form-data">
            ...
            <div class="hidden">
                ...
                <input type="hidden" name="id" class="border pl-2 border-[#000] h-[40px] w-[75%] rounded-[10px]">
            </div>

            <div class="">
                <div class="font-bold mb-3 text-[18px]">Tên chức vụ</div>
                <input type="text" name="name_role" class="border pl-2 border-[#000] h-[40px] w-[75%] rounded-[10px]">
