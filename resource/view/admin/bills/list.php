    ...
    <div class="container mx-auto flex gap-5 mt-4">
        ...
        <div class="grow">
            <div class="w-full mx-auto">
                <div class="">
                    <div class="bg-[#525151] text-white p-[10px] text-[18px] leading-[20px] rounded-t-lg">Danh sách hóa đơn</div>
                    <div class="pb-[15px] border border-[#ccc] border-solid rounded-b-lg">
                            ...
                            <table>
                                ...
                                <?php foreach ($bills as $bill) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="border border-[#000] p-2 bg-[#d62d20] text-white" href="./Xoa-hoa-don?id=<?= $bill->id ?>" onclick="return confirm('Bạn có chắc muốn xóa không?')">Xóa</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
